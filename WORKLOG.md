...
- Modular pipeline policy with saved artifacts for source profiling, DOCX extraction, authoring brief, template analysis, LaTeX authoring, compilation, quality gate, and reporting.
