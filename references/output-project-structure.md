...
For this branch, prefer the embedded `nwputhesis` project generated by:
...
The generated project should contain only the selected thesis tree:

```text
project/
  main.tex
  bachelor.tex or graduate.tex
  nwputhesis.cls
  infra/
  content/
    figures/
...
Do not keep both undergraduate and graduate content directories in a generated project.
